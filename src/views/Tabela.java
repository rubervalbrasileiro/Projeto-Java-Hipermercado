...
public class Tabela extends javax.swing.JFrame {
    ...
    public void carregarDados() {
        ...
        for (Produto p : produtoDAO.listaProdutos()) {
            ...
            try {
                ...
                quantidade = p.getQtd(); // Assumindo que pode lançar a exceção
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Produtos",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 51))); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addComponent(txtDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 301,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 20,
                                                        Short.MAX_VALUE)
                                                .addComponent(txtQtd, javax.swing.GroupLayout.PREFERRED_SIZE, 83,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(44, 44, 44)
                                                .addComponent(txtPreco, javax.swing.GroupLayout.PREFERRED_SIZE, 73,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(55, 55, 55)
                                                .addComponent(txtTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 73,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(24, 24, 24))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGap(18, 18, 18)
                                                .addComponent(btnExcluir, javax.swing.GroupLayout.PREFERRED_SIZE, 92,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(btnAtualizar, javax.swing.GroupLayout.PREFERRED_SIZE, 92,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(btnLimpar, javax.swing.GroupLayout.PREFERRED_SIZE, 92,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(btnFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 92,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(btnImprimir, javax.swing.GroupLayout.PREFERRED_SIZE, 92,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tabela",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 51))); // NOI18N
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        try {
            if (tblTabela.getSelectedRow() != -1) {
                ...
                double qtd = Double.parseDouble(txtQtd.getText().replace(",", ".")); // Quantidade
                double preco = Double.parseDouble(txtPreco.getText().replace(",", ".")); // Preço unitário

                // ARREDONDAMENTO MATEMÁTICO:
                // Isso transforma 14.8500000000001 em exatamente 14.85
                double totalReal = Math.round((qtd * preco) * 100.0) / 100.0;

                // Chama o método atualizar, passando os valores capturados
                produtoDAO.atualizar(id, produto, qtd, preco, totalReal);

                exibirNaTabela(produtoDAO.listaProdutos());
                ...
                JOptionPane.showMessageDialog(this, "Selecione um produto na tabela para atualizar.", "Erro",
                        JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Erro ao atualizar: Verifique os campos numéricos!", "Erro",
                    JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Erro ao atualizar o produto: " + e.getMessage(), "Erro",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    try {
        ...
        String qtdTexto = txtQtd.getText().trim().replace(",", ".");
        String precoTexto = txtPreco.getText().trim().replace(",", ".");

        p.setProduto(txtDescricao.getText().trim());
        p.setQtd(Double.parseDouble(qtdTexto));
        p.setPreco(Double.parseDouble(precoTexto));
...
}//GEN-LAST:event_btnCadastrarActionPerformed// GEN-LAST:event_btnCadastrarActionPerformed
    ...
    private void btnAtualizarMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_btnAtualizarMouseClicked
        ...
        if (tblTabela.getSelectedRow() != -1) {
            ...
            // txtId.setText(tblTabela.getValueAt(tblTabela.getSelectedRow(),
            // 0).toString());
    ...
    private void tblTabelaMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tblTabelaMouseClicked
        // TODO add your handling code here: // Pega os valores da linha selecionada e
        // preenche nos campos
        if (tblTabela.getSelectedRow() != -1) {

            // txtId.setText(tblTabela.getValueAt(tblTabela.getSelectedRow(),
            // 0).toString()); o id ocultado pois não tem
            // no jframe
            txtDescricao.setText(tblTabela.getValueAt(tblTabela.getSelectedRow(), 1).toString());
            txtQtd.setText(tblTabela.getValueAt(tblTabela.getSelectedRow(), 2).toString());
            txtPreco.setText(tblTabela.getValueAt(tblTabela.getSelectedRow(), 3).toString());
    ...
    private void tblTabelaKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_tblTabelaKeyReleased
        // TODO add your handling code here: Responsável pela movimentação da troca de
        // linha <-- --> seta
        if (tblTabela.getSelectedRow() != -1) {
            // Pega os valores da linha selecionada e preenche nos campos
            // txtId.setText(tblTabela.getValueAt(tblTabela.getSelectedRow(),
    ...
    private void btnAtualizarKeyPressed(java.awt.event.KeyEvent evt) {
    if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
        ...
        try {
            if (tblTabela.getSelectedRow() != -1) {
                ...
                int id = Integer.parseInt(
                        tblTabela.getValueAt(tblTabela.getSelectedRow(), 0).toString()
                );

                String produto = txtDescricao.getText().trim();
                String qtdTexto = txtQtd.getText().trim().replace(",", ".");
                String precoTexto = txtPreco.getText().trim().replace(",", ".");
            ...
            JOptionPane.showMessageDialog(this,
                    "Erro ao atualizar: Verifique os campos numéricos!",
                    "Erro",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void txtDescricaoKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtDescricaoKeyPressed
        // TODO add your handling code here: quando a tcl ENTER precionada avança para
        // quantidade
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            txtQtd.requestFocus();
        }
    ...
    private void txtPrecoKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtPrecoKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            // for Atualizar basta selecionar na tabela ");
    ...
    private void exibirNaTabela(List<Produto> produtos) {
        ...
        for (Produto p : produtos) {
            modelo.addRow(new Object[] {
                    p.getId(),
                    p.getProduto(),
                    // Formata para 2 casas decimais apenas para exibição
                    df.format(p.getQtd()),
                    df.format(p.getPreco()),
                    df.format(p.getTotal())
            });
        }
    }
    ...
    private void btnFiltroActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnFiltroActionPerformed
        ...
        // Tenta converter a quantidade, preço e total, se os campos não estiverem
        // vazios
        /*
         * try {
         * if (!qtdTexto.isEmpty()) {
         ...
         * preco = Double.parseDouble(precoTexto.replace(",", ".")); // Substitui
         * vírgula por ponto, se necessário
         * }
         ...
         * "Erro ao converter os números. Verifique os valores inseridos.");
         * return;
         * }
         * 
         * // Verifica se o campo do produto está vazio ou se algum dos campos está
         * preenchido para o filtro
         ...
         * List<Produto> produtosFiltrados = produtoDao.filtro(filtroProduto, qtd,
         * preco, total);
         * //atualizarTabela(produtosFiltrados); // Atualiza a tabela com os produtos
         * filtrados
         * } catch (SQLException e) {
         * JOptionPane.showMessageDialog(null, "Erro ao filtrar produto: " +
         * e.getMessage());
         * }
         * }
         */
        ...
        btnImprimir.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (complete) {
                        JOptionPane.showMessageDialog(null, "Impressão concluída com sucesso!", "Imprimir",
                                JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(null, "Impressão cancelada!", "Imprimir",
